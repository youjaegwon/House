...
<section style="background: url('${path}/user/img/photogrid.jpg') center center repeat; background-size: cover;" class="bar background-white relative-positioned">
        <div class="container">
          <!-- Carousel Start-->
              ...
              <div class="homepage owl-carousel">
                <div class="item">
                  <div class="row">
                    <div class="col-md-5 text-right">
                      <p><img src="${path}/user/img/logo.png" alt="" class="ml-auto"></p>
                      <h1>끈질긴 허위매물 뿌리 뽑는다.</h1>
                      <p>Business. Corporate. Agency.<br>Portfolio. Blog. E-commerce.</p>
                    </div>
                    <div class="col-md-7"><img src="${path}/user/img/template-homepage.png" alt="" class="img-fluid"></div>
                  </div>
                </div>
                <div class="item">
                  <div class="row">
                    <div class="col-md-7 text-center"><img src="${path}/user/img/template-mac.png" alt="" class="img-fluid"></div>
                    <div class="col-md-5">
                ...
                <div class="item">
                  <div class="row">
                    ...
                    <div class="col-md-7"><img src="${path}/user/img/template-easy-customize.png" alt="" class="img-fluid"></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="box-simple">
                ...
                <h3 class="h4">팀워크</h3>
                <p>하나의 목표를 위해 서로 다른 역활의 다양한 사람이 함께 한다는 것을 인정합니다. 서로가 최고가 될 수 있도록 서로를 돕습니다.</p>
              </div>
            </div>
            <div class="col-lg-4 col-md-6">
              <div class="box-simple">
                ...
                <h3 class="h4">DNA</h3>
                <p>우리는 운좋은 한번의 성공을 바라지 않습니다. 성공을 반복할 수 있는 '방법'을 습득하고 체계화, 시스템화 하고자 합니다.</p>
              </div>
            </div>
          </div>
        </div>
      </section>
      <section style="background: url(${path}/user/img/fixed-background-2.jpg) center top no-repeat; background-size: cover;" class="bar no-mb color-white text-center bg-fixed relative-positioned">
        ...
        <div class="container">
          ...
          <p class="text-center"><a href="index2.html" class="btn btn-template-outlined-white btn-lg">See More</a></p>
        </div>
      </section>
          ...
          <div class="row">
            <div class="col-lg-3">
              <div class="home-blog-post">
                <div class="image"><img src="${path}/user/img/portfolio-4.jpg" alt="..." class="img-fluid">
