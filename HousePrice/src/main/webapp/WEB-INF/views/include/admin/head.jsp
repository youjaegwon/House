...
<!-- 	<link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
 -->	
    ...
    <!-- Bootstrap core CSS     -->
    <link href="${path}/assets/css/bootstrap2.min.css" rel="stylesheet" />
    ...
    <link href="${path}/assets/css/light-bootstrap-dashboard.css?v=1.4.0" rel="stylesheet"/>
